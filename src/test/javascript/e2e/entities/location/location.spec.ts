...
describe('Location e2e test', () => {
  ...
  it('should load create Location page', async () => {
    ...
    expect(await locationUpdatePage.getPageTitle().getAttribute('id')).to.match(/sampleSiApp.location.home.createOrEditLabel/);
  ...
  it('should delete last Location', async () => {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/sampleSiApp.location.delete.question/);
