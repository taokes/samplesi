    ...
    return (
      <div>
        <h2 id="employee-heading">
          <Translate contentKey="sampleSiApp.employee.home.title">Employees</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sampleSiApp.employee.home.createLabel">Create a new Employee</Translate>
          </Link>
        </h2>
          ...
          >
            {employeeList && employeeList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('firstName')}>
                      <Translate contentKey="sampleSiApp.employee.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('lastName')}>
                      <Translate contentKey="sampleSiApp.employee.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('email')}>
                      <Translate contentKey="sampleSiApp.employee.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('phoneNumber')}>
                      <Translate contentKey="sampleSiApp.employee.phoneNumber">Phone Number</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('hireDate')}>
                      <Translate contentKey="sampleSiApp.employee.hireDate">Hire Date</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('salary')}>
                      <Translate contentKey="sampleSiApp.employee.salary">Salary</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('commissionPct')}>
                      <Translate contentKey="sampleSiApp.employee.commissionPct">Commission Pct</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="sampleSiApp.employee.manager">Manager</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="sampleSiApp.employee.department">Department</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="sampleSiApp.employee.home.notFound">No Employees found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
